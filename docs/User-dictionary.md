...
**Example in this project:**
- When an admin invites a new member, the system sends an onboarding email using `sendTransactionalEmail()`. The email includes a temporary password and a link to activate the account.
